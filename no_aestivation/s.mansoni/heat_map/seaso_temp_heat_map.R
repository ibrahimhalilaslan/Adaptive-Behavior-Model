...
#start looping the simulation for each temperature and seasonlality value 
for(epsilon in 22:length(seasonality)){
...
par(mfrow=c(2,1))
densit_plot <- ggplot(df, aes(x = x, y = y, colour = MPB,), x ) + geom_point(size = 4, shape = 7)
