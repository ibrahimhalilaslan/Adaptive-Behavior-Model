...
# The reduction of mortality due to aestivation
re_est <- 20
re_est_i <- 2
...
#Start loop for the simulation for each parameter set of aestivation 
...
prevalence_percentage_m[[m]] <- wormPrevalenceSh(out_come_season_mpb)
